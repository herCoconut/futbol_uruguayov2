...
def get_temporadas(id_liga):
    return _get("search_all_season.php", {"id": id_liga})

def get_partidos_temporada(id_liga, temporada="2025-2026"):
    return _get("eventsseason.php", {"id": id_liga, "s": temporada})

def get_tabla(id_liga, temporada="2025-2026"):
...
def get_proximos_partidos_liga(id_liga):
    return _get("eventsnextleague.php", {"id": id_liga})

def get_ultimos_partidos_liga(id_liga):
